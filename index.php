...
<section class="main-info">
    <div class="container">
        <div class="row-fluid">
            <div class="span3">
                <a class="btn btn-success btn-large pull-right" href="http://shapebootstrap.net">اطلب الان </a>
            </div>
            <div class="span9">
                <h4 class="text-right">يمكنك طلب الخدمة من الموقع الان </h4>
                <p class="no-margin text-right"> يمنك طلب اى خدمة م الوقع الان فقط راسلنا و سوف نجيب عليك </p>
            </div>
...
<section id="services">
    <div class="container">
        <div class="center gap">
            <h3>خدمات الشركة </h3>
            <p class="lead">نلقي نظرة على بعض المشاريع الأخيرة أكملنا للعملاء valuble لدينا</p>
        </div>
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading text-right">عنوان</h4>
                        <p class="text-right">ألسنة اللهب والشيخوخة محزن والخوف وmalesuada Pellentesque مقيم مرضي turpis الحاجة. دهليز هوز، feugiat الحياة، ultricies eget، tempor الجلوس امات، ما كان عليه سابقا. كما هو الحال دائما ندرة Donec الاتحاد الأوروبي يبيرو الجلوس امات. حياتي هو حقا سريعة. Mauris الاتحاد الأوروبي الأسد.</p>
                    </div>
                </div>
            </div>
...
<section id="clients" class="main">
    <div class="container">
        ...
        <div class="span2">
            <div class="clearfix">
                <h4 class="pull-right text-right">OUR PARTNERS</h4>
                <div class="pull-left">
                    <a class="prev" href="#myCarousel" data-slide="prev"><i class="icon-angle-left icon-large"></i></a> <a class="next" href="#myCarousel" data-slide="next"><i class="icon-angle-right icon-large"></i></a>
                </div>
            </div>
            <p class="text-right">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
        </div>
    </div>
</div>
</section>
